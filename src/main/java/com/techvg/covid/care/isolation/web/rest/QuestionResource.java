...
import com.techvg.covid.care.isolation.service.QuestionQueryService;
import com.techvg.covid.care.isolation.service.QuestionService;
...
/**
 * REST controller for managing {@link com.techvg.covid.care.isolation.domain.Question}.
 */
@RestController
@RequestMapping("/api")
