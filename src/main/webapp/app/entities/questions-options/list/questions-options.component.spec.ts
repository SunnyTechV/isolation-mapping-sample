...
describe('QuestionsOptions Management Component', () => {
  let comp: QuestionsOptionsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'questions-options', component: QuestionsOptionsComponent }]),
      ...
      .overrideTemplate(QuestionsOptionsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.questionsOptions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
