...
describe('Isolation Management Component', () => {
  let comp: IsolationComponent;
  let fixture: ComponentFixture<IsolationComponent>;
  let service: IsolationService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'isolation', component: IsolationComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(IsolationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.isolations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
