...
describe('AssessmentAnswer Management Component', () => {
  let comp: AssessmentAnswerComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'assessment-answer', component: AssessmentAnswerComponent }]),
      ...
      .overrideTemplate(AssessmentAnswerComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.assessmentAnswers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
